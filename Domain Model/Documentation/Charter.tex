...
\begin{document}
\title{\textbf{AgriSenso Documentation} \\ 
}
\author{
\normalsize
Maglasang, Catherine \\
...
\label{chpt: Charter}
\section{Abstract}
AgriSenso is an open-source, python-based ecommerce platform for online merchants. It provides the power to grow your Agri-business, reach more customers and sell more agricultural products. It enables businesses to experience an integrated workflow for their business - Accounting and Order Management and Customer Service under one platform. 

\section{Vision}
To have a successful farm business and a productive and progressive economy that promotes agriculture.

\section{Mission}
To develop a platform  that solves the problems of marketing and help farmers sell seasonal products.
...
\item When the seller adds a product all the information of the product must be complete
...
\section{Persona}
\subsection{Seller}
Mang Ben is a 40-year-old farmer. He owned a land in the province. He had an abundant farm products but he doesn’t have a place in the market. Also, he doesn’t have a regular buyer to his products. Due to this issue, there will be a big probability to have a failure in terms of product not being sold.  Man Ben needs a system in which the farmers won’t have to worry about their farm products not being able to be sold. and assured that their product will be bought regularly.

\subsection{Customer}
Mr. Kyle is a 60-year-old businessman. His business is retailing fruits. Sadly, he has an arthritis and he cannot go to the market to buy fruits. His looking for an app where he can buy or order fruits online without going to the market.

\section{User Stories}
\begin{enumerate}
\item As an seller, I want to login to the website
\item As an seller, I want to be able to logout of the website
...
\item As an seller, I want to view the orders of my customers
\item As an seller, I want to add products
\item As an seller, I want to view all the products
\item As an seller, I want to view all my customers
\item As an seller, I want to view my sales report
...
Post - Condition 	& The product details are outputted in the product table in seller dashboard \\ 
Main Course			& 1. The user accesses the product page in seller dashboard \\
 					& 2. The client fetches the api resource url ‘/products/’ \\
...
Main Course			& 1. The user accesses the product page \\
					...
					& 3. The client fetches the api resource url ‘/products/2’ \\ 
...
Main Course			& 1. The user accesses the product page \\
					...
					& ‘/products/’  and adds the form inputs as a data parameter \\ 
					& in json form \\
...
Post - Condition 	& The supplier is added in the database and can be viewed on the supplier \\ 
					& list page \\ 
Main Course			& 1. The seller is on the  supplier page. \\
					& 2. The seller Clicks on the add Supplier tab and is redirected to the \\ 
					& add supplier form \\
					& 3. The seller enters the name, address, phone number, fax, and email of \\
					& the supplier \\
					& 4. The seller clicks on the submit button \\
...
Exceptions 			& 4.a There is a blank input box. \\
					& \qquad 1.1 The seller will redirected to the add supplier form \\
					& \qquad 1.2 There is a message that tells the seller to fill in all input boxes \\
...
Post - Condition 	& \\ 
Main Course			& 1. The seller is on the  supplier page. \\
					& 2. The seller Clicks on the update Supplier button and is redirected to the \\ 
					& \quad \thinspace update supplier form \\
					& 3. The seller enters the name, address, phone number, fax, and email \\ 
...
Main Course			& 1. The seller is on the  order page. \\
					& 2. The seller Clicks on the add order tab and is redirected to the add order form \\
...
Alternate Flows		& \\
Exceptions 			& 4a There is a blank input box. \\
					& \qquad 1.1 The seller will redirected to the add order form \\
					& \qquad 1.2 There is a message that tells the admin to fill in all input boxes \\
					& \qquad 1.3 Back to step 4 \\
...
Pre - Condition 		& The seller is on the Admin dashboard page \\ 
Post - Condition 	& The list of all orders is shown \\ 
Main Course			& 1. The seller clicks on the order tab and will then be redirected to \\ 
					& \quad \thinspace the  order page. \\
					& 2. The seller Clicks on the view orders tab and is redirected to the \\ 
...
Main Course			& 1. The seller is on the order page. \\
					& 2. The seller Clicks on the add order item button and is redirected to \\ 
					& \quad \thinspace the add order item form \\
					& 3. The seller enters the order id, product id, unit price, discount and quantity \\
					& 4. The seller clicks on the submit button \\
...
Main Course			& 1. The seller is on the cart page \\
					& 2. The seller clicks on the add cart tab and is redirected on the add cart form page \\
					& 3. The seller inputs the cart session id, date created and customer id. \\
					& 4. The seller clicks on the submit button \\
...
Primary Actors 		& Seller \\
Pre - Condition 		& The seller is on the Seller dashboard page \\ 
Post - Condition 	& The list of all carts is shown \\ 
Main Course			& 1. The seller clicks on the cart tab and will then be redirected to the  cart page. \\
					& 2. The seller Clicks on the view carts tab and is redirected to the cart list page \\
...
Primary Actors 		& Seller \\
Pre - Condition 		& The seller is in the Seller dashboard \\ 
Post - Condition 	& The category will be added in the category list \\ 
Main Course			& 1. The seller is in the admin dashboard. \\
					& 2. The seller clicks the add category button and will be displayed in the category page. \\
					& 3. The seller clicks on the add button. \\
...
\label{chap:SQAP}
\section{Abstract}
This document is about the Software Quality Assurance Plan $(SQAP)$ of the system, AgriSenso which is an e-commerce platform for online merchants. It provides the power to grow your Agri-business, reach more customers and sell more agricultural products. It enables businesses to experience an integrated workflow for their business - Accounting and Order Management and Customer Service under one platform. 
.
\section{Introduction}
\subsection{Purpose}
The purpose of this plan is to define the AgriSenso Software Quality Assurance (SQA) organization, SQA tasks and responsibilities; provide reference documents and guidelines to perform the SQA activities; provide the standards, practices and conventions used in carrying out SQA activities; and provide the tools, techniques, and methodologies to support SQA activities, and SQA reporting.
	
\subsection{Scope}
This plan establishes the SQA activities performed throughout the life cycle of the e-store project.

This plan shall implement a project that follows the RESTful architectural style. The project shall be developed using the Flask microframework. There will be a clear separation of concerns between the client and the server for easy maintenance and scalability.The project shall be implemented in Vagrant with CentOS and Puppet.
...
CentOS			& a Linux distribution that attempts to provide a free, enterprise-class, community-supported computing platform functionally compatible with its upstream source, Red Hat Enterprise Linux \\
...
Seller 			& The owner of the products sold in the store. \\
...
\item \url {https://www.centos.org/}
\item \url {https://puppet.com/}
\end{itemize}
...
The documents to be delivered in the specific phases of the project will be based in Chapter 5, Section 5. Document standards are described in the same section. The Diagrams will be at \hyperref[chap:Diagrams]{Chapter 6}.
...
Item      				& /products/ & GET & Retrieve all products       			\\
          					& /products/:id & GET & Retrieve single product 			\\
          					& /products/:id & PUT & Update product 						\\ 
          					& /products/ & POST & Create new product 					\\ \hline
Type						& /types/ & GET & Retrieve all product types 			\\
							& /types/:id & GET & Retrieve all types \\ 
							& /types/:id & PUT & Update type \\ 
							& /types/ & POST & Create new type \\ \hline
Attribute				& /types/:id/attributes/ & GET & Retrieve all attributes under the type id \\ 
							& /types/:id/attributes/:id/ & GET & Retrieve single attribute under the type id \\
							& /types/:id/attributes/ & POST & Create new attribute under the type id \\
							& /types/:id/attributes/:id/ & PUT & Update attribute details under the type id \\ \hline
AttributeValue		& /items/:id/attributes/ & GET & Retrieve all type-attribute pair values for each product assigned to a particular type \\ 
							& /items/:id/attributes/:id/ & GET & Retrieve a single type-attribute pair value for a product \\ 
							& /items/:id/attributes/:id/ & PUT & Update the type-attribute pair value \\ 
							& /items/:id/attributes/ & POST & Create new attribute value based on the type assigned to a product \\ \hline
Image 					& /items/:id/images/ & GET & Retrieve all images for a single product \\
							& /items/:id/images/:id/ & GET & Retrieve single image for an product \\ 
							& /items/:id/images/:id/ & PUT & Update image for an product \\
							& /items/:id/images/ & POST & Create new image for an  \\ \hline
Supplier				& /suppliers/ & GET & Retrieve all suppliers \\ 
							& /suppliers/:id/ & GET & Retrieve single supplier \\ 
							& /suppliers/:id/ & PUT & Update a supplier \\ 
							& /suppliers/	& POST & Create new supplier \\ \hline
Cart \& POS Module  \\ \hline
Cart 						& /carts/			& POST & Create new cart instance  \\ 
							& /carts/:id/ 	& PUT &  Update Cart  \\ \hline
CartItem				& /carts/:id/products/ & GET & Retrieve all cart products \\ 
							& /carts/:id/products/:id/ & GET & Retrieve single cart product \\
							& /carts/:id/products/:id/ & PUT & Update single cart product \\
							& /carts/:id/products/ & POST & Add an product to cart \\ \hline
Order					& /orders/ & GET & Retrieve all orders \\ 
							& /orders/:id/ & GET & Retrieve single order \\ 
							& /orders/:id/ & PUT & Update single order \\ 
							& /orders/ & POST & Create new order \\ \hline
OrderItem				& /orders/:id/products/ & GET & Retrieve all order products \\ 
							& /orders/:id/products/:id/ & GET & Retrieve single order item \\ 
							& /orders/:id/products/:id/ & PUT & Update single order product\\
							& /orders/:id/products/ & POST & Add new product in order \\ \hline
Wishlist 				& /wishlists/ & GET & Retrieve all created wishlists \\ 
							& /wishlists/:id/ & GET & Retrieve single wishlist \\ 
							& /wishlists/:id/ & PUT & Update wishlist \\ 
							& /wishlists/ & POST & Create new wishlist \\ \hline
WishlistItem			& /wishlists/:id/products/ & GET & Retrieve all products under a single wishlist \\ 
							& /wishlists/:id/products/:id/ & GET & Retrieve single wishlist product \\ 
							& /wishlists/:id/products/:id/ & PUT & Update wishlist product\\
							& /wishlists/:id/products/ & POST & Add new product in wishlist  \\ \hline
User 					& /users/ & GET & Retrieve all users \\ 
							& /users/:id/ & GET & Retrieve single user \\
							& /users/:id/ & PUT & Update user \\ 
							& /users/ & POST & Create new user \\  \hline							
							
Customer 			& /site/:id/customers/ & GET & Retrieve all customers in a site \\ 
							& /site/:id/customers/:id/ & GET & Retrieve single customer in a site \\
							& /site/:id/customers/:id/ & PUT & Update customer in a site \\ 
							& /site/:id/customers/ & POST & Register new customer in site or business \\ 				
\end{tabular}
}
...
\begin{center}
 ...
 \cline{2-3}
	...
	\hline
	Suppliers Button 	& Click 					& Display Supplier Page. GET Resource '/suppliers/' \\
	\hline
	Customers Button 	& Click 					& Display Customer Page. GET Resource '/customers/' \\		
	\end{tabular}
	...
	\hline
	AgriSenso Logo 		& Click 					& Display Dashboard Page \\
	\hline 
...
\item All versions of the Documentation and the early versions of the Source Code is freely available at the project repository at \url {https://github.com/catherinemaglasang/AgriSenso} 
...
\label{chap:Diagrams}
\begin{figure}[h!]
\includegraphics[width=\linewidth]{Diagrams/ERD.png}
\caption{Class Diagram}
\label{fig:ClassDiagram}
\end{figure}

\begin{figure}[h!]
\includegraphics[width=\linewidth]{Diagrams/burndownchart1.png}
\caption{Burndown Chart for Sprint 1}
\label{fig:Burndown Chart - Sprint 1 }
\end{figure}

\begin{figure}[h!]
\includegraphics[width=\linewidth]{Diagrams/burndownchart2.png}
\caption{Burndown Chart for Sprint 3}
\label{fig:Burndown Chart - Sprint 2 }
\end{figure}

\begin{figure}[h!]
\includegraphics[width=\linewidth]{Diagrams/burndownchart3.png}
\caption{Burndown Chart for Sprint 3}
\label{fig:Burndown Chart - Sprint 3 }
\end{figure}


\begin{figure}[h!]
\includegraphics[width=\linewidth]{Diagrams/kanbanboard.png}
